...
| Approach | Error metric | Elapsed time |
|------------------------|------------------------|------------------------|
...
*A `r round(1 - (auc_speedy /auc_basic), 4)*100`% decrease in predictive performance in `r round( (bm_speedy$median[1] /bm_basic$median[1]), 3)*100`% of the time.*
